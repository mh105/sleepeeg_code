function [ EEG ] = SleepEEG_downsample(subID, fnsuffix, dsrate, verbose, oversave, project, dataDir, datafn)
%
...
if ~exist('dataDir', 'var')
    [dataDir, datafn, fileID, ~] = SleepEEG_configDir(subID, fnsuffix, verbose, project);
end
