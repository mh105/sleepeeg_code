...
&#x1F536;
  ...
  Usage: [varargout] = <strong>SleepEEG_call</strong>(subID, fnsuffix, '<flag#1>',<arg#1>...'<flag#n>',<arg#n>);
 ...
 **ADSLEEPEEG_PREPROCESSING FUNCTION - SINGLECHANSPEC**
 ...
 ###### Inputs:
           ...
           - data:         a M x N matrix containing data of a single
                           channel without downsampling (could be
                           downsampled as well).
